...
I live in Seattle and work on AI agents in [Visual Studio Code](https://code.visualstudio.com/) and [GitHub Copilot](https://github.com/features/copilot) at Microsoft. I focus on agent products, evaluation, and OpenTelemetry-based observability.

[Website](https://b1tank.github.io) · [LinkedIn](https://www.linkedin.com/in/zhichao-li-engineer) · [Writing](https://b1tank.github.io/writing/)
...
Before developer tools, I worked on cloud infrastructure, distributed tracing, and Azure Managed Grafana. My route into software began in chemical engineering and scientific computing.
...
| **Learn C** | A hand-written, runnable browser companion to K&R. No signup, tracking, or generated course content. | [Repository](https://github.com/b1tank/learnc) · [Course](https://b1tank.github.io/learnc/) |
| **OpenSnipping** | A browser-based screenshot and annotation tool with local editing and export. | [Repository](https://github.com/b1tank/opensnipping-web) · [Demo](https://b1tank.github.io/projects/opensnipping/demo/) |
...
| **Git Remote Helper** | Turn selected local lines in VS Code into durable GitHub links pinned to a commit. | [Repository](https://github.com/b1tank/git-remote-helper) |
...
Outside work, I enjoy basketball and billiards. I’m a Warriors fan and still find Stephen Curry’s combination of movement, geometry, repetition, and calm unusually instructive.
